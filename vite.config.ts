...
const renderSeoHead = (route: SeoRoute) => {
  ...
  return [
    ...
    `    <meta property="og:image:type" content="${siteMetadata.socialImage.type}" />`,
    `    <meta property="og:image:width" content="${siteMetadata.socialImage.width}" />`,
    `    <meta property="og:image:height" content="${siteMetadata.socialImage.height}" />`,
    `    <meta property="og:image:alt" content="${escapeHtml(siteMetadata.socialImage.alt)}" />`,
    '    <meta name="twitter:card" content="summary" />',
    `    <meta name="twitter:title" content="${escapeHtml(route.title)}" />`,
    `    <meta name="twitter:description" content="${escapeHtml(route.description)}" />`,
    `    <meta name="twitter:creator" content="${siteMetadata.twitterHandle}" />`,
    `    <meta name="twitter:image" content="${socialImageUrl}" />`,
    `    <meta name="twitter:image:alt" content="${escapeHtml(siteMetadata.socialImage.alt)}" />`,
