...
function App() {
  ...
  useEffect(() => {
    ...
    const handleKeyUp = (e: KeyboardEvent) => {
      console.log("App component detected keyup:", e.key);
    };
  ...
  const handlePlayClick = (e: React.MouseEvent) => {
    ...
    console.log("Play with fish clicked");
    setShowText(false);
  };
      ...
      {showText && (
        <div className="text">
          <p>
            ...
            <br />
            <br />I like making awesome stuff, if you'd like to reach out to me
            follow these links:
          </p>
          <ul>
            <li>
              <a
                href="http://github.com/cazala"
                target="_blank"
